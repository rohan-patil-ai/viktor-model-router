...
# Cheaper sibling per family, per the official pricing sheet (scripts/pricing.json):
# claude-fable-5 is actually the most expensive Claude tier, so sonnet is the cheap
# sibling there; gpt-5.6-luna is the cheapest model overall.
